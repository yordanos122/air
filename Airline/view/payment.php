...
<!------ Include the above in your HEAD tag ---------->
 <div style="position: absolute;left: 80%;top: 35%; background-color: gray;">
       <img src="../assete/logo.png">
       <h2>Use this website to quickly find</h2>
       <h2>the most important information about</h2>
       <h2>Ethio:Tickets Flights, Departures, Arrivals,</h2>
       <h2>and other information about Ethio Ticket.</h2>
       <h2>Plan your travel to ADD Airport with the</h2>
       <h2>information provided in this site.</h2> 
    </div>
