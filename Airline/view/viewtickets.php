...
<form method="POST">
<div style="position: absolute;top: 40%;left: 30%; width: 20%;">
...
<div style="position: absolute;left: 110%; top: -2%; width: 80%;">
...
<div class="form-group">
<div>
<input class="btn btn-primary" type="submit" name="save" value="OK">
</div>
</div>
</div>
</form>                    
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="single-widget widget-quick-links">
                                ...
                                <ul>
                                    ...
                                    <li><a href="payment.php">Paymnet</a></li>
